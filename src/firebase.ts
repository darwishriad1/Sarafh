...
// Create a secondary app to safely register cashiers into Firebase Auth without logging out the admin
let secondaryApp;
try {
  secondaryApp = initializeApp(firebaseConfig, 'secondary-auth-app');
} catch (e) {
  console.warn("Secondary Firebase app initialization skipped or failed:", e);
}
